...
<%
    Booking.flight_booking_id = request.getParameter("source");
    Booking.flight_name = request.getParameter("destination");
%>
<!DOCTYPE html>
<html>
<head>
...
<div class="w3-bar w3-white w3-card" id="myNavbar">
    <a href="./index.jsp" class="w3-bar-item w3-button w3-wide"><img src="img/favicon.png" class="img-fluid" alt="image" width="18%"> Airline</a>
        ...
        <section class="row justify-content-center">
            ...
            <section class="col-sm-6 col-md-3">
                <form action="./payment.jsp" method="post" class="form-container">
                    ...
                    <br>
                    <button type="submit" class="teal" value="Submit">Submit</button>
                </form>
            </section>
        </section>
    </section>
