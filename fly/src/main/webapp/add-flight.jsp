...
<div class="w3-bar w3-white w3-card" id="myNavbar">
    <a href="./index.jsp" class="w3-bar-item w3-button w3-wide"><img src="img/favicon.jpeg" class="form-control" alt="image" width="18%">  Airline</a>
    <div class="w3-right w3-hide-small">
        <a href="./login.jsp" class="form-control"><i class="fa fa-gear"></i> Admin Signin</a>
    </div>
</div>
<div class="container">
