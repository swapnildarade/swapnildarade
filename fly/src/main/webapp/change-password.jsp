    ...
    <div class="container">
        <h1>Password Change</h1>
            ...
            %>
                ...
                <form action="./Chan" method="post">
                    <div>
                        <label class="sr-only">Email address : abc</label>
                    </div>
                    <div class="form-group mx-sm-3 mb-2">
                        <label for="inputPassword" class="sr-only">New Password</label>
                        <input type="password" name="passwordEntered" class="form-control" id="inputPassword" placeholder="new password">
                        <br><small id="passwordHelp" class="form-control">&nbsp;&nbsp; Current Password :&nbsp;<%= Login.pass %></small>
                    </div>
