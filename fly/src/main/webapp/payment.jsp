...
<div class="w3-bar w3-white w3-card" id="myNavbar">
    <a href="./index.jsp" class="w3-bar-item w3-button w3-wide"><img src="img/favicon.jpeg" class="img-fluid" alt="image" width="18%">  FlyAway</a>
    <div class="w3-right w3-hide-small">
        <a href="./login.jsp" class="teal"><i class="fa fa-gear"></i> Admin Login</a>
    </div>
</div>
        ...
        <section class="row justify-content-center">
           ...
           <section class="col-sm-6 col-md-3">
               <form action="${pageContext.request.contextPath}/thank-you.jsp" method="post" class="form-container">
                   ...
                   <button type="submit" class="teal" value="Submit">Confirm Payment</button>
               </form>
          </section>
        </section>
    </section>
